...
import { formatEmailList, formatEmailDetail, extractBodyFromPayload, decodeSnippet } from '../../server/formatting/markdown.js';
    ...
    formatDetail: (data, ctx) => {
        switch (ctx.operation) {
            ...
            default: {
                ...
                // loses; see ADR-305).
                const bodyFormat = ctx.params.bodyFormat ?? 'plain';
